...
if len(sys.argv) > 3:
    ...
    print "Arguments given are:   Upper_arm_len = %.2f, Lower_arm_len= %.2f, Shoulder_height= %.2f" %(float(sys.argv[1]),float(sys.argv[2]),float(sys.argv[3]))
    upper_arm_len = float(sys.argv[1])
    lower_arm_len = float(sys.argv[2])
    shoulder_height = float(sys.argv[3])

else:
    print("Incorrect Arguments given, creating URDF with default values: Upper_arm_len = 0.44, Lower_arm_len= 0.44, Shoulder_height= 0.0")
    upper_arm_len = 0.44
    lower_arm_len = 0.44
    shoulder_height = 0.0
...
printCylinderLink('base_link',0,0,shoulder_height/2,0,0,0,0,shoulder_height,0,0.9,0.9,1.0,'Cyan')
...
printRevoluteJoint('left_shoulder_forward_joint','revolute','base_link','left_shoulder_forward_link',0,0,shoulder_height,0,0,0,-0.6,1.0,10,3,0,0,1)
...
printRevoluteJoint('left_wrist_joint','fixed','left_lower_arm_link','left_wrist_link',0,0,-lower_arm_len/2,0,0,0,-0.77,0.77,10,3,1,0,0)
