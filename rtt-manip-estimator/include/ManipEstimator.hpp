...
private:
    ...
    // Current Joint angles of the KUKA

    RTT::InputPort<rstrt::kinematics::JointAngles> cur_joint_angles_in_port;
    RTT::FlowStatus                                cur_joint_angles_in_flow;
    rstrt::kinematics::JointAngles                 cur_joint_angles_in_data;

    // Current Base position with resepct to camera frame

    RTT::InputPort<KDL::Frame> cur_base_pose_in_port;
    RTT::FlowStatus            cur_base_pose_in_flow;
    KDL::Frame                 cur_base_pose_in_data;
